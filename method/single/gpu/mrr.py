...
if __name__ == "__main__":
    ...
    class TestMethod(unittest.TestCase):
        ...
        def test_single_MrR_method(self):
            N = TestMethod.N
            A, b = toepliz_matrix_generator.generate(N=N,diag=2.5)
            print(f'N:\t{N}')
            A, b= cp.asarray(A), cp.asarray(b)

            self.assertTrue(mrr(A, b, TestMethod.epsilon, TestMethod.T))
